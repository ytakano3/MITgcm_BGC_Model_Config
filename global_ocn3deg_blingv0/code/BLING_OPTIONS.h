...
C undef USE_QSW - global verification does NOT use exf (external forcing)
#undef USE_BLING_V1
...
C Note (Y.T): For additional tracers, ADVECT_PHYTO can be turned on.
#undef ADVECT_PHYTO
...
C define ML_MEAN_LIGHT - global verification NOT defined in the original setup
