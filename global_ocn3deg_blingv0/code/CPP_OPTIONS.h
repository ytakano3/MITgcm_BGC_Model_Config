...
C Note (Y.T): this was turned on in my previous version (c63s), not sure why turned off
C           : KPP needs CPP flag SHORTWAVE_HEATING enabled, turn on when using KPP
...
C Note (Y.T): this is turned on now to balance freshwater flux.
#define ALLOW_BALANCE_FLUXES

C o Include/exclude balancing surface forcing relaxation code
C Note (Y.T): this is turned on now to balance salinity relaxation.
...
C Note (Y.T): this might be worth trying, check the reference etc.
C Code: /model/src/ini_mixing.F
