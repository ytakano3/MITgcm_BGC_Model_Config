...
C--   PARAMETER (nWh=618)/ manually changed the in the header file, to 618 
C     (following the bling adjoint example), could adjust the number based on 
C     STDOUT information (debug level 3) (STDOUT gives tapeFileCounter = 605).
